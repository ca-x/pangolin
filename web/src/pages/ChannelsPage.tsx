...
import { AutoDisableEditor, ChannelSettingsEditor, EndpointMappingsEditor, ParameterOverridesEditor, RetryStatusesEditor } from './documentEditors'
...
function ChannelLifecycleActions({ row }: { row: Document }) {
  ...
  const [name, setName] = useState(t('channelCloneName', { name: String(row.name) }))
